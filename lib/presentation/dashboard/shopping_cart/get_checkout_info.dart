...
class _GetCheckoutInfoScreenState extends State<GetCheckoutInfoScreen> {
  ...
  String countryCodeValue = "Please Tap to Select";
  String countryCode = "";
              ...
              Column(
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    initialValue:
                        widget.fromUpdate! ? _con.firstNameInitVal.value : '',
                  ...
                  AppTextField(
                    ...
                    // errorMessage: _con.emailError,
                    initialValue:
                        widget.fromUpdate! ? _con.lastNameInitVal.value : '',
                  ...
                  AppTextField(
                    ...
                    // errorMessage: _con.emailError,
                    initialValue:
                        widget.fromUpdate! ? _con.emailInitVal.value : '',
                    errorMessage: _con.emailError,
                    onChange: (val) {
                  ...
                  AppTextField(
                    ...
                    // errorMessage: _con.emailError,
                    initialValue:
                        widget.fromUpdate! ? _con.addressInitVal.value : '',
                  ...
                  AppTextField(
                    ...
                    // errorMessage: _con.emailError,
                    initialValue:
                        widget.fromUpdate! ? _con.postCodeInitVal.value : '',
                  ...
                  widget.fromUpdate!
                      ? AppButton(
                          onPressed: () {
                            ...
                            int index = addressCtr
                                .addressModel.addressList!.value
                                .indexWhere((element) =>
                                    element.email == _con.emailCtr.text);
                            print(index);

                            if (index != -1) {
                              addressCtr.addressModel.addressList![index]
                                  .firstName!.value = _con.firstNameCtr.text;
                              addressCtr.addressModel.addressList![index]
                                  .lastName!.value = _con.lastNameCtr.text;
                              addressCtr.addressModel.addressList![index].email!
                                  .value = _con.emailCtr.text;
                              addressCtr.addressModel.addressList![index]
                                  .phoneNumber!.value = _con.phoneNoCtr.text;
                              addressCtr.addressModel.addressList![index]
                                  .address!.value = _con.addressCtr.text;
                              addressCtr.addressModel.addressList![index]
                                  .postalCode!.value = _con.postCodeCtr.text;
                              addressCtr
                                  .addressModel
                                  .addressList![index]
                                  .country!
                                  .value = _con.countryDropDownValue.value;
                              addressCtr.addressModel.addressList![index].state!
                      ...
                      : AppButton(
                          ...
                          onPressed: () async {
                            if (_con.validate()) {
                              if (_con.countryDropDownValue.value.isEmpty ||
                                ...
                                address.country!.value =
                                    _con.countryDropDownValue.toString();
                                address.state!.value =
                                    _con.statesDropdownvalue.toString();
