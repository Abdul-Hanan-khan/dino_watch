...
class HomeController extends GetxController {
  ...
  getProductByCat({required String catId}) async {
    ...
    productsModal.value = (await HttpService.getProductsByCategory(catId: catId))!;
    loadFav();
...
//
//     for (var element in cartController.favourites.productIds!.value) {
//
//       int index =
//           productsModal.value.products!.indexWhere((chunkP) => chunkP.productId == element);
//       if (index != -1) {
//         productsModal.value.products![index].isFavourite!.value = true;
//       }
//     }
